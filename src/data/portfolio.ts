...
export const portfolio = {
  profile: {
    name: "Varun Mahajan",
    tagline: "Varun Mahajan",
    headline: "Lead Engineer · AI & Full-Stack · React, Next.js, LangGraph, Python",
    ...
    projectDetails: [
      {
        ...
        label: "AI Project",
        period: "2025 – Present",
        role: "Lead Engineer — architected the full agentic system, designed the LangGraph state graph, built the FastAPI backend, Next.js portal, and guardrail layers.",
        description:
        ...
        technologies: ["LangGraph", "LangChain", "FastAPI", "Python", "Next.js", "React", "GraphQL", "MongoDB", "Azure ADLS", "ServiceNow API"],
        outcome: "Eliminates manual BOM analysis effort for engineering teams — production deployment in progress at UHG Optum.",
      },
      {
        name: "Invictus (Protein Synthesis)",
        label: "Open Source",
        period: "2024 – Present",
        role: "Solo builder — full-stack design, LLM pipeline, NLP integration, and frontend UI.",
        description:
        ...
        technologies: ["Next.js", "React", "TypeScript", "FastAPI", "Ollama", "scispaCy", "Node.js", "Vercel"],
        outcome: "Live demo at invictus-prototype.vercel.app — showcases independent AI system design.",
        githubUrl: "https://github.com/human-again/invictus-prototype",
        liveUrl: "https://invictus-prototype.vercel.app",
      },
      {
        name: "Optum Contract Analysis Tool",
        label: "AI Project",
        period: "2025 – Present",
        role: "Lead Engineer — led full architecture design, component development, performance optimization, and release planning.",
        description:
          "Production AI platform for UHG Optum that extracts and analyzes contract PDF data using OpenAI + RAG + vector databases. SMEs use the tool to review, compare, and improve future contracts. Built with a Next.js frontend, GraphQL API layer, and SSE-based streaming for a real-time chat interface.",
        technologies: ["Next.js", "TypeScript", "OpenAI", "RAG", "pgvector", "GraphQL", "Python", "Azure", "MongoDB"],
        outcome: "40% reduction in contract SME analysis time — live in production at UHG Optum.",
      },
      {
        name: "Medicare M3P Payment SDK",
        label: "Project",
        period: "2023 – 2024",
        role: "Lead Engineer — led architecture, team coordination, API schema definition, and Storybook documentation.",
        description:
          "A payment SDK for Medicare prescription plans (M3P), built as web components for easy multi-client integration. Features Stripe payment collection, micro-frontend architecture published to Jfrog Artifactory, config-as-a-service for zero-code client customization, A/B testing, and WCAG 2.1 compliance.",
        technologies: ["Next.js", "React 18", "TypeScript", "Redux", "Stripe", "Webpack", "Kubernetes", "Docker", "Azure", "GitHub CI/CD"],
        outcome: "Delivered as SDK to multiple Optum clients — +15% conversion improvement across integrated plans.",
      },
      {
        name: "JoeFresh eCommerce",
        label: "Project",
        period: "2020 – 2023",
        role: "Lead Engineer — managed a team of 10, led architecture, code reviews, performance optimization, and WCAG compliance.",
        description:
          "Re-platformed and redesigned Loblaw Digital's JoeFresh eCommerce site from a legacy stack to a modern Next.js architecture. Built components for the org-wide internal UI library, led AODA/WCAG 2.0 compliance, and drove stakeholder communications throughout.",
        technologies: ["Next.js", "React 18", "TypeScript", "Redux", "Node.js", "GraphQL", "Kubernetes", "Docker", "K6", "GitLab CI/CD"],
        outcome: "Conversion +20%, AOV +10%, Time on Site +15% post-launch.",
      },
      {
        name: "Loblaw Digital – Store Fulfillment Tool",
        label: "Project",
        period: "2018 – 2020",
        role: "Lead Engineer — built from scratch, GraphQL layer design, and rollout to all stores.",
        description:
          "Internal Next.js + GraphQL (Apollo) order fulfillment tool for Loblaw store colleagues to process in-store orders. Built from scratch with GraphQL wrapping existing APIs and scaled to multiple stores across Canada.",
        technologies: ["Next.js", "React 17", "Redux", "GraphQL", "Apollo", "AgGrid", "HTML5", "CSS3", "Jenkins CI/CD"],
        outcome: "Deployed to all Loblaw stores across Canada.",
      },
      {
        name: "Bed Bath & Beyond eCommerce Redesign",
        label: "Project",
        period: "2017 – 2018",
        role: "Senior Frontend Engineer — led frontend architecture, component development, and team mentorship.",
        description:
          "Redesign of the Bed Bath & Beyond eCommerce website. Led frontend architecture, component development, and mentored the team. Worked with React, Redux-Saga, and a Node.js/Express backend.",
        technologies: ["React", "Redux", "Redux-Saga", "Node.js", "Express", "HTML5", "CSS3", "Jenkins CI/CD"],
        outcome: "Full eCommerce redesign shipped to production.",
      },
      {
        name: "Cardinal Health MedeComm B2B Platform",
        label: "Project",
        period: "2016 – 2017",
        role: "Senior Frontend Engineer — set up architecture, led component design, coordinated with onsite teams.",
        description:
          "New B2B eCommerce platform for Cardinal Health featuring powerful search, smart cart, and checkout. Built with Angular2 and integrated with Adobe AEM. Set up architecture, led component design, and coordinated with onsite teams.",
        technologies: ["Angular2", "Node.js", "HTML5", "CSS3", "D3", "Adobe AEM", "Jasmine", "Cucumber", "Jenkins"],
        outcome: "Launched as Cardinal Health's primary B2B ordering platform.",
      },
    ],
