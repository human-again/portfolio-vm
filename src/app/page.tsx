...
export default function Home() {
  ...
  return (
    <main id="main-content" className="flex flex-col items-center justify-center min-h-screen px-4 py-8 relative">
      <InfoButton />
      ...
      <div className="flex flex-col items-center gap-6 sm:gap-8 w-full max-w-2xl">
        ...
        <motion.div
          ...
          transition={prefersReduced ? { duration: 0 } : { duration: 0.4, delay: 0.4 }}
        >
      ...
      {/* Watermark — decorative, hidden from screen readers */}
      <div
        aria-hidden="true"
        className="absolute bottom-4 left-0 right-0 flex justify-center pointer-events-none select-none overflow-hidden"
      >
